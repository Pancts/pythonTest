...
file_01=codecs.open('testm.dpl','w+','utf-8')
file_01.write('DAUMPLAYLIST'+'\n')
...
for (i,j)in zip(id,title):
    ...
    file_01.write(str(n)+"*file*http://dlhls.cdn.zhanqi.tv/zqlive/"+i+'.m3u8\n')
    file_00.write(str(n)+"*title*"+j+'\n')
    file_01.write(str(n)+"*title*"+j+'\n')
    n=n+1
    #print(i,j)
